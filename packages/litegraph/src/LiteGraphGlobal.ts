...
export class LiteGraphGlobal {
  ...
  NODE_TITLE_COLOR = "#adbac7"
  NODE_SELECTED_TITLE_COLOR = "#cdd9e5"
  NODE_TEXT_SIZE = 14
  NODE_TEXT_COLOR = "#768390"
  NODE_TEXT_HIGHLIGHT_COLOR = "#adbac7"
  NODE_SUBTEXT_SIZE = 12
  NODE_DEFAULT_COLOR = "#1c2128"
  NODE_DEFAULT_BGCOLOR = "#22272e"
  NODE_DEFAULT_BOXCOLOR = "#373e47"
  NODE_DEFAULT_SHAPE = RenderShape.ROUND
  NODE_BOX_OUTLINE_COLOR = "#373e47"
  NODE_ERROR_COLOUR = "#f85149"
  NODE_FONT = "Arial"
  ...
  WIDGET_BGCOLOR = "#1c2128"
  WIDGET_OUTLINE_COLOR = "#373e47"
  WIDGET_ADVANCED_OUTLINE_COLOR = "rgba(49, 109, 202, 0.8)"
  WIDGET_TEXT_COLOR = "#adbac7"
  WIDGET_SECONDARY_TEXT_COLOR = "#768390"
  WIDGET_DISABLED_TEXT_COLOR = "#545d68"

  /** Zoom threshold below which DOM widgets are hidden (default: 0.5) */
  DOM_WIDGET_ZOOM_THRESHOLD = 0.5

  LINK_COLOR = "#316dca"
  EVENT_LINK_COLOR = "#f85149"
  CONNECTING_LINK_COLOR = "#3fb950"
