...
// Translated from: nodes/core/market/utils/hurst_plot_node.py
//
...
import { calculateHurstOscillator } from '../../../../services/indicator-calculators/hurst-calculator';
import { calculateEma } from '../../../../services/indicator-calculators/ema-calculator';
import { calculateCco } from '../../../../services/indicator-calculators/cco-calculator';
import { calculateMesaStochasticMultiLength } from '../../../../services/indicator-calculators/mesa-stochastic-calculator';
 ...
 */
export class HurstPlot extends Base {
  static inputs = {
  ...
  static outputs = {
    ...
    hurst_data: getType('ConfigDict'),
    ohlcv_bundle: getType('OHLCVBundle'),
    mesa_data: getType('ConfigDict'),
    cco_data: getType('ConfigDict'),
  };
