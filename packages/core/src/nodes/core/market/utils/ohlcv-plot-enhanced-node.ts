...
import { calculateSma } from '../../../../services/indicator-calculators/sma-calculator';
import { calculateVbp } from '../../../../services/indicator-calculators/vbp-calculator';
...
export class OHLCVPlotEnhanced extends Base {
  ...
  protected async executeImpl(
    ...
    if (showVbp) {
      apiKey = getVault().get('POLYGON_API_KEY');
      if (!apiKey) {
        showVbp = false;
      }
    }
