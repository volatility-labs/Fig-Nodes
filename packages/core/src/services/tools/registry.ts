...
const _CREDENTIAL_PROVIDERS: Map<string, CredentialProvider> = new Map();
 ...
 */
export function registerCredentialProvider(name: string, provider: CredentialProvider): void {
  if (!name) {
 ...
 */
export function getCredentialProvider(name: string): CredentialProvider | undefined {
 ...
 */
export function getAllCredentialProviders(): Record<string, CredentialProvider> {
