// backend/core/type-utils.ts
// Translated from: core/types_utils.py
 ...
 * Note: This is a simplified version since TypeScript types are erased at runtime.
 * For runtime type checking, use Zod schemas instead.
 */
export function parseTypeString(typeStr: string): Record<string, unknown> {
  // Handle generic types like List[string], Dict[string, number], etc.
