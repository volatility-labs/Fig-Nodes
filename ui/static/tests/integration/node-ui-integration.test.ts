...
describe('Node UI Integration Tests', () => {
    ...
    test('Node connection typing integration', () => {
        ...
        expect(targetNode.onConnectInput(inputIndex, 'str', outputSlot, sourceNode, 0)).toBe(true);
        ...
        const unionInputIndex = unionTargetNode.findInputSlot('input');
        expect(unionTargetNode.onConnectInput(unionInputIndex, 'str', outputSlot, sourceNode, 0)).toBe(true);
        expect(unionTargetNode.onConnectInput(unionInputIndex, 'int', intSourceNode.outputs[0], intSourceNode, 0)).toBe(true);
    });
