 ...
 * @abstract
 */
export declare abstract class BaseAreaPlugin<Schemes extends BaseSchemes, Signals> extends Scope<Signals, [Root<Schemes>]> {
    abstract nodeViews: Map<NodeId, NodeView>;
    abstract connectionViews: Map<ConnectionId, ConnectionView>;
    abstract area: Area;
