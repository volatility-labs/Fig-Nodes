...
class PolygonBatchCustomBars(Base):
    ...
    Bar Interval: The bar interval is determined by combining multiplier and timespan:
    - multiplier × timespan = bar interval
    - Examples: multiplier=5, timespan=minute → 5-minute bars
                multiplier=1, timespan=day → daily bars
                multiplier=1, timespan=hour → hourly bars
    """
    ...
    default_params = {
        ...
        "adjusted": True,
        "sort": "asc",
        "limit": 50000,  # Increased for longer lookback periods (2 years of 5min = ~210k bars)
