...
def test_calculate_lod_happy_path():
    ...
    assert result["atr"][0] is None  # ATR calculator returns None for initial periods
...
def test_calculate_lod_insufficient_data():
    ...
    # All values None since insufficient data for ATR
    assert result["lod_distance_pct"][-1] is None
...
def test_calculate_lod_single_bar():
    ...
    # Returns None since insufficient data for ATR
    assert result["lod_distance_pct"][0] is None
