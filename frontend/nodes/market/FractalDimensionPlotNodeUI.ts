...
class FractalDimensionPlotRenderer extends NodeRenderer {
    onDrawForeground(ctx: CanvasRenderingContext2D) {
        const node = this.node as FractalDimensionPlotNodeUI;
        node.drawPlots(ctx);
...
export default class FractalDimensionPlotNodeUI extends BaseCustomNode {
    ...
    constructor(title: string, data: any, serviceRegistry: any) {
        ...
        this.renderer = new FractalDimensionPlotRenderer(this);
