...
class FractalDimensionAdaptivePlotRenderer extends NodeRenderer {
    onDrawForeground(ctx: CanvasRenderingContext2D) {
        const node = this.node as FractalDimensionAdaptivePlotNodeUI;
        node.drawPlots(ctx);
...
export default class FractalDimensionAdaptivePlotNodeUI extends BaseCustomNode {
    ...
    constructor(title: string, data: any, serviceRegistry: any) {
        ...
        this.renderer = new FractalDimensionAdaptivePlotRenderer(this);
