...
export default class PolygonStockUniverseNodeUI extends BaseCustomNode {
    ...
    syncWidgetValues() {
        ...
        if (this.widgets && this.constructor.name === 'PolygonStockUniverseNodeUI') {
            // Hardcode the params to match PolygonStockUniverse params
            const params = [
                ...
                { name: 'exclude_etfs', label: 'Exclude ETFs' },
