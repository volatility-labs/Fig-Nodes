...
class FractalsATRPlotRenderer extends NodeRenderer {
    onDrawForeground(ctx: CanvasRenderingContext2D) {
        const node = this.node as FractalsATRPlotNodeUI;
        node.drawPlots(ctx);
...
export default class FractalsATRPlotNodeUI extends BaseCustomNode {
    ...
    constructor(title: string, data: any, serviceRegistry: any) {
        ...
        this.renderer = new FractalsATRPlotRenderer(this);
